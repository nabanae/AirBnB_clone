...
class HBNBCommand(cmd.Cmd):
    ...
    def do_show(self, arg):
        ...
        Display the string representing a class instance of a given id.
        """
        argl = parse(arg)
        objdict = storage.all()
        if len(argl) == 0:
    ...
    def do_count(self, arg):
        ...
        Retrieve the number of instance of a class."""
        argl = parse(arg)
        count = 0
        for obj in storage.all().values():
    ...
    def do_update(self, arg):
        """ Usage: update <class> <id> <attribute_name> <attribute_value> or
            ...
            Update class instance of a known id by adding or updating
